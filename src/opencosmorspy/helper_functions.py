...
def calculate_squared_distances(coord: np.array, diagonal_element=0.):
...
if __name__ == "__main__":
    ...
    int_arr_dct['A_int'] = np.loadtxt(r'publication/test_A_int.csv',
                                      delimiter=',')
    int_arr_dct['A_mf'] = np.loadtxt(r'publication/test_A_mf.csv',
                                      delimiter=',')
    int_arr_dct['A_hb'] = np.loadtxt(r'publication/test_A_hb.csv',
                                      delimiter=',')
    int_arr_dct['tau'] = np.loadtxt(r'publication/test_tau.csv',
                                      delimiter=',')
